      ...
      <div className="flex justify-center overflow-hidden">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-screen-lg p-8">
          {categories.map((category) => (
            <div
              key={category._id}
              className="w-full h-32 flex items-center justify-center bg-orange-500 text-white text-xl font-bold cursor-pointer rounded-md shadow-lg transition-transform transform hover:scale-105 hover:bg-orange-600 active:scale-95 sm:w-40 md:w-48 md:h-48"
